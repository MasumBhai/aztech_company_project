# Generated by Django 3.2.4 on 2021-07-31 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_quote', models.TextField(blank=True, help_text="Client's quote for us", null=True, verbose_name="Client's comment")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('company_code', models.CharField(default='coded by Masum phone(+8801551805248)', max_length=256, primary_key=True, serialize=False)),
                ('company_logo', models.ImageField(blank=True, null=True, upload_to='company-logo/%Y/%m/', verbose_name='Company-logo-should-be-nice')),
                ...
                ('company_phone', phone_field.models.PhoneField(help_text='company-official-phone-number', max_length=31)),
                ('company_address', models.CharField(blank=True, max_length=256, null=True, verbose_name='company-office-address')),
                ('company_facebook', models.URLField(blank=True, null=True, verbose_name='company-facebook-link-(if any)')),
                ('company_youtube', models.URLField(blank=True, null=True, verbose_name='company-youtube-link-(if any)')),
                ('company_linkedin', models.URLField(blank=True, null=True, verbose_name='company-linkedin-link-(if any)')),
                ('company_instagram', models.URLField(blank=True, null=True, verbose_name='company-instagram-link-(if any)')),
