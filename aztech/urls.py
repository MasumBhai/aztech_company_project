...
urlpatterns = [
    ...
    path('industries/e-commerce/', views.eCommerce, name='eCommerce'),
    path('industries/e-learning/', views.eLearning, name='eLearning'),
    path('industries/e-health-software/', views.eHealthSoftware, name='eHealthSoft'),  # navbar style change korte hobe
    path('industries/e-health-app/', views.eHealthApp, name='eHealthApp'),  # svg is not working
    path('industries/logistics/', views.eLogistics, name='eLogistics'),
    path('industries/retail-software/', views.eRetail, name='eRetail'),  # our clients part
    path('industries/retail-software/', views.eRetail, name='eRetail'),
