...
class OurClients(models.Model):
    ...
    client_name = models.CharField(max_length=MAX_LENGTH, help_text="Client's individual name or Company name", blank=True,
                                   null=True)
    client_logo = models.ImageField(upload_to='client_Logo/%Y/%m/%d/', blank=True, null=True,
                                    verbose_name="client image/logo")
    ...
    client_address = models.CharField(max_length=MAX_LENGTH, help_text="Client's Home/Office Address", blank=True, null=True)
    client_project_title = models.CharField(max_length=MAX_LENGTH, help_text="Client's Project Title We Have Done", blank=True,
                                            null=True)
    client_project_link = models.URLField(max_length=MAX_LENGTH,
...
class BlogPost(models.Model):
    title = models.CharField(max_length=MAX_LENGTH, verbose_name="Blog Title Info", blank=True, null=True)
    slug = models.SlugField(max_length=MAX_LENGTH, blank=True, null=True, unique=True, verbose_name="Link name(slug field)")
    ...
    created_on = models.DateTimeField(default=timezone.now, blank=True, null=True,
                                      verbose_name="Blog post created time")
...
class LatestProjects(models.Model):
    ...
    project_title = models.CharField(max_length=MAX_LENGTH, help_text="Project Title", blank=True, null=True)
    project_client = models.CharField(max_length=MAX_LENGTH, help_text="Project's client descriptions", blank=True, null=True)
    project_industries = models.CharField(max_length=MAX_LENGTH, help_text="Helpful to which which industries", blank=True,
                                          null=True)
    project_services = models.CharField(max_length=MAX_LENGTH, help_text="Services provided during this project", blank=True,
                                        null=True)
    project_technologies = models.CharField(max_length=MAX_LENGTH, help_text="Technologies used in this Project", blank=True,
                                            null=True)
    ...
    project_slug = models.SlugField(max_length=MAX_LENGTH, blank=True, null=True, unique=True)
...
class SoftwareCompany(models.Model):
    company_code = models.CharField(default='coded by Masum phone(+8801551805248)', max_length=MAX_LENGTH, primary_key=True)
    ...
    company_mail = models.EmailField(verbose_name='company-official-mail-address', max_length=120, blank=True,
                                     null=True)
    company_phone = PhoneField(verbose_name="company-official-phone-number")
    company_address = models.TextField(verbose_name="company-office-address", max_length=MAX_LENGTH, blank=True, null=True)
    ...
    years_of_collaborations = models.PositiveSmallIntegerField(verbose_name="years-of-collaborations-with-client",
                                                               blank=True, null=True)
    clients_total_number = models.PositiveSmallIntegerField(verbose_name="total-clients-number", blank=True, null=True)
    experts_hired_total = models.PositiveSmallIntegerField(verbose_name="total-experts-hired-uptill", blank=True,
                                                           null=True)
    product_delivers_total = models.PositiveSmallIntegerField(verbose_name="total-product-delivered-uptill", blank=True,
                                                              null=True)
