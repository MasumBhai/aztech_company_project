...
class CompanyAdmin(admin.ModelAdmin):
    ...
    fields = ['company_code',('company_logo','company_address'),('company_mail','company_phone'),('company_facebook','company_youtube'),('company_linkedin','company_instagram'),('company_name','clients_total_number'),('years_of_experiences','years_of_collaborations'),('experts_hired_total','product_delivers_total'),'company_description']
